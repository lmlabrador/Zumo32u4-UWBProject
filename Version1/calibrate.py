import time
import math
from Zumo import Zumo  # Import your Zumo robot class

# Constants for calibration
MOTOR_SPEED = 350  # Speed for calibration (adjust as needed)
CALIBRATION_DISTANCE = 1.0  # Distance to travel for calibration (in meters)
CALIBRATION_ANGLE = 10  # Angle to turn for calibration (in degrees)
